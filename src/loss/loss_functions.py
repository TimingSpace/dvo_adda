...
def SingleShotLoss(predict_result,ground_truth):
    ...
    loss = loss.sum()
    return loss
def GroupWithATTLoss(f_12,f_g_12,att_12,b_21,b_g_21,att_21,f_23,f_g_23,att_23,b_32,b_g_32,att_32,f_13,f_g_13,att_13,b_31,b_g_31,att_31):
...
def GroupLoss(f_12,f_g_12,b_21,b_g_21,f_23,f_g_23,b_32,b_g_32,f_13,f_g_13,b_31,b_g_31):
...
def GroupWithSSLoss(f_12,f_g_12,b_21,b_g_21,f_23,f_g_23,b_32,b_g_32,f_13,f_g_13,b_31,b_g_31):
    f_g_12 = f_g_12.view(f_g_12.size(0),6,1,1)
    #f_g_13 = f_g_13.view(f_g_12.size(0),6,1,1)
    #f_g_23 = f_g_23.view(f_g_12.size(0),6,1,1)
    b_g_21 = b_g_21.view(f_g_12.size(0),6,1,1)
